...
function hasProperty(obj, property) {
  if (property in obj) {
    ...
    return `Property ${property} exists`; // Повертаємо текст, якщо властивість існує
  } else {
    return `Property ${property} does not exist`; // Повертаємо текст, якщо властивість не існує
  }
  // Використовуємо оператор "in" для перевірки наявності властивості
...
function changeRole(array, newRole) {
  for (let user of array) user.role = newRole;
  console.log(array);
